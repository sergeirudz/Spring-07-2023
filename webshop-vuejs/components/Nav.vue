                    ...
                    <div class="flex items-center">
                        <div class="hidden md:block">
                            <div class="flex items-baseline ml-10 space-x-4">
                                ...
                                <button class="text-gray-300 hover:text-gray-800" @click="handleLogout">Logout</button>
                                <div class="pl-10 text-gray-300 flex justify-center align-middle text-center">
                                    <h3>{{ loggedInText }}</h3>
                                </div>
                            </div>
                        </div>
